...
exec_visualization = ['show_objects_in_bev_labels_in_camera'] # options are 'show_range_image','front_camera_image', 'show_bev', 'show_pcl', 'show_labels_in_image', 'show_objects_and_labels_in_bev', 'show_objects_in_bev_labels_in_camera', 'show_tracks', 'show_detection_performance', 'make_tracking_movie'
...
while True:
    try:
        ...
        if 'front_camera_image' in exec_list:
            pcl.frame_camera_image(frame, camera_name)
            cv2.waitKey(vis_pause_time)
